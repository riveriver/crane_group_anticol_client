 ...
 *  Every project needs a tailored copy of this file renamed to am_modbus_config.h, and added to the include path.
 */
...
#define TIMEOUT_MODBUS 200 // Timeout for master query (in ticks)
